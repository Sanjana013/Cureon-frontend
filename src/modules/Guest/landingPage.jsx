...
// import promo from "@/assets/static/promo.mp4";
...
//   // Add this at the top of your LandingPage component
//   const messages = [
//     "Hi, I’m Curomate",
...
//       <nav className="flex justify-between items-center p-6 bg-white/30 backdrop-blur-md sticky top-0 z-50 shadow-xl">
//         {/* Logo */}
//         <h1 className="text-3xl font-extrabold text-[#293379] tracking-wide hover: cursor-default">
//           Cureon
//         </h1>
...
//           <Link
//             to="/"
//             className="font-medium text-[#293379] hover: transition-all duration-300"
//           >
//             Home
//           </Link>
//           <Link
...
//               <Button className="bg-[#293379] text-white font-semibold px-5 py-2 rounded-full shadow-md hover:cursor-pointer">
//                 Explore
//               </Button>
//             </DropdownMenuTrigger>
//             <DropdownMenuContent className="bg-white/90 backdrop-blur-md border-0 shadow-2xl rounded-xl p-2 w-60">
//               {[
//                 { title: "Quick Consultations", ref: medicationRef },
//                 { title: "Instant Doctor Appointments", ref: appointmentsRef },
//                 { title: "Medication Reminders", ref: trackerRef },
//                 { title: "Additional Features", ref: additionalRef },
//               ].map((item, idx) => (
//                 <DropdownMenuItem
//                   key={idx}
//                   className="rounded-lg hover:bg-gradient-to-r hover:from-[#3b82f6] hover:to-[#4e46e571] hover: transition-all duration-300 cursor-pointer"
...
//       {/* Hero Content */}
//       {/* <div className="flex flex-col items-center justify-center flex-grow text-center text-white py-28 w-full">
//           <div className="w-full bg-white/70 backdrop-blur-md p-12 md:p-24 shadow-2xl">
//             <h2 className="text-5xl md:text-6xl font-bold mb-6 text-[#293379]">
...
//             </p>
//             <Link to="/login">
//               <Button className="px-10 py-3 text-lg bg-[#293379] text-white">
//                 Get Started
//               </Button>
//             </Link>
//           </div>
//         </div> */}
//       {/* Hero Section */}
//       <div className="flex flex-col md:flex-row items-center justify-center min-h-[85vh] bg-gradient-to-br from-blue-100 via-blue-50 to-blue-200 px-10 md:px-16 py-10 md:py-0">
//         {/* Left: Hero Text */}
//         <div className="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left space-y-8">
//           <h2 className="text-5xl md:text-6xl font-extrabold text-[#293379] leading-tight">
//             Your Health Companion
//           </h2>
...
//           <div>
//             {/* <Link to="/login">
//               <Button className="px-10 py-4 text-xl bg-[#293379] text-white hover: shadow-md cursor-pointer">
//                 Get Started
//               </Button>
//             </Link> */}
//             <button
//               onClick={() => window.open(promo, "_blank")}
//               className="watch-btn bg-[#293379] text-white px-6 py-3 rounded-full font-semibold"
//             >
...
//           {/* Speech Bubble */}
//           <div className="absolute top-4 md:top-4 bg-white text-[#293379] px-5 py-2 rounded-full shadow-lg text-sm font-semibold flex items-center gap-2 animate-bounce transition-all duration-500">
//             <div className="flex items-center gap-2 text-[rgb(30,48,80)] leading-none">
//               <FaRegHandPaper className="text-[rgb(30,48,80)]" />
//               <span>
//                 {messages[msgIndex].includes("Curomate") ? (
//                   <>
//                     Hi, I’m{" "}
//                     <span className="font-bold text-[#fa003f]">Curomate</span>
//                   </>
//                 ) : (
//                   messages[msgIndex]
//                 )}
...
//       {/* Features Section */}
//       <section className="py-20 px-6 md:px-32 space-y-24 bg-gradient-to-br from-blue-100 via-blue-50 to-blue-200">
//         <FeatureCard
...
//       {/* Footer */}
//       <footer className="bg-[#293379] backdrop-blur-md text-white/90 p-8 mt-auto shadow-inner">
...
//               Designed with <i className="fa-solid fa-heart text-[#fa003f]"></i>{" "}
//               for your health
//             </p>
//           </div>
...
//               <i class="fa-solid fa-mobile"></i> +91 00000 00000
//             </p>
//             <p className="text-sm text-white/80">
//               <i class="fa-solid fa-envelope"></i> support@cureon.com
//             </p>
//             <p className="text-sm text-white/80">
//               <i class="fa-solid fa-location-dot"></i> 123 Health Street,
//               Kolkata, India
//             </p>
...
//               <a
//                 href="#"
//                 className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-black transition-all duration-300"
//               >
//                 <i className="fa-brands fa-x-twitter"></i>
//               </a>
//               <a
//                 href="#"
//                 className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-gradient-to-tr from-[#feda75] via-[#fa7e1e] to-[#d62976] transition-all duration-300"
//               >
...
//         {/* Policy Links Row */}
//         <div className="flex flex-wrap justify-center gap-6 text-sm text-white/80 mt-10">
//           <a href="#" className="hover:text-[#fa003f] transition-colors">
//             Privacy Policy
//           </a>
//           <a href="#" className="hover:text-[#fa003f] transition-colors">
//             Terms of Service
...
//         {/* Bottom Bar */}
//         <div className="border-t border-white/20 mt-1 pt-3 text-center text-white/70 text-xs">
...
// //       <div className="md:w-1/2 flex flex-col justify-center text-[#293379]">
...
//   // 🔁 Observer to detect visibility every time it enters the viewport
//   useEffect(() => {
...
//         if (refProp) refProp.current = node; // Keep parent ref working
//       }}
//       className={`flex flex-col md:flex-row items-center gap-10 p-6 md:p-10 ${
//         reverse ? "md:flex-row-reverse" : ""
//       }`}
...
//       {/* Animated text */}
//       <motion.div
//         className="md:w-1/2 flex flex-col justify-center text-[#293379]"
